import os
from funciones.logica import crear_almacen, crear_articulo, pantalla, pantalla_de_inventario
        ...
        while True:
            try:   
                ...
                if opciones_invetario == 1:
                    ...
                    inventario_de_almacen[retirar].pop(retirar)#elimiina el objecto
